...
$lang = array_merge($lang, [
	'CF_CPT_TITLE_EXPLAIN'		=> 'Hier auf der Seite können Sie die Einstellung für die Begrenzung festlegen. Im Normalfall ist die Eingabe eines Zeit-Formates, das in der Zukunft liegt, gesperrt. Das hat den Hintergrund, dass, wenn man einen Beitrag so ändert, dass dieser ein zukünftiges Datum hat, der Beitrag für die Benutzer immer als ungelesener Beitrag markiert wird. Selbst wenn der Benutzer den Beitrag gelesen hat oder wenn der Benutzer die Option benutzt „Alle Foren als gelesen markieren“. Der Beitrag wird solange als ungelesen angezeigt, bis das aktuelle Datum höher ist als das des Beitrages. Daher wird davon abgeraten. Allerdings kann es Probleme mit dem Ändern geben in Bezug auf die Zeitzonen. Daher habe ich hier einige Optionen mit eingebunden.',
	...
	'CF_CPT_OPTION_EXPLAIN'		=> 'Hier können Sie die gewünschte Option auswählen.<br><br>Erklärungen dazu finden sich im Kopfbereich dieser Seite.<br><br><b>Standard:</b> Option Nr. 1',

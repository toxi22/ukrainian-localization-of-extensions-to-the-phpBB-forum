...
$lang = array_merge($lang, [
	...
	'HELP_DL_COMMENTS'			=> 'Активируйте систему комментариев для этой категории.<br />Пользователи, включенные в раскрывающиеся списки, могут просматривать и/или оставлять комментарии в этой категории.<br />Администраторы и модераторы могут редактировать и удалять все комментарии, авторы могут управлять своими текстами.',
